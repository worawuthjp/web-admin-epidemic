        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="idcard" name="rfidno" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="idcard" name="rfidname" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" >rfid_status<span class="required">:</span> </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="idcard" name="rfidstatus" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $sql = " insert into tb_rfid(rfid_no,rfid_name,rfid_status,admin_id)";
                    $sql .= " values ('$rfidno','$rfidname','$rfidstatus','$adminid')";
