...
<div class="right_col" role="main">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>เพิ่มข้อมูลRFIDผู้ใช้งาน</h2>
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="idcard" name="status" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select type="text" id="name" name="rfid_id" required="required" class="form-control col-md-7 col-xs-12">
                                <option value=""></option>
                               <?php
                                $a='1';
                ...
                <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        ...
                        <a href="show_rfiduser.php" class="btn btn-danger">ยกเลิก</a>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $sql = " insert into tb_rfiduser(rfiduser_status,rfid_id,user_id)";
                    $sql .= " values ('$status','$rfid_id','$user_id')";
